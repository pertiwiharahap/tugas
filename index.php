...
<section id="intro">
    ...
    <section id="subscribe">
      <div class="container wow fadeInUp">
        ...
        <form method="POST" action="ceknim.php">
          <div class="form-row justify-content-center">
            <div class="col-auto">
              <input type="password" class="form-control" placeholder="Silahkan masukkan nim anda" name="nim">
            </div>
            <div class="col-auto">
              <button type="submit">Silahkan klik disini </button>
            </div>
          </div>
        </form>
